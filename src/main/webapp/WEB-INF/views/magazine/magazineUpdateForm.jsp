                  ...
                  <form id="updateForm" method="post" action="update.mag" enctype="multipart/form-data">
                      <table align="center">
                        ...
                        <tr>
                          ...
                          <td><input multiple="multiple" type="file" id="reupfile" class="form-control" name="reupfile" onchange="checkFile();">
                          	  
                          	  <c:if test="${ not empty mag.magazineImgName }">
                          	  	<img src="${ mag.magazineImgName }" width="500px" height="300px" style="margin-top: 10px;">
                        ...
                        <tr>
	                     ...
	                     <td><input type="text" id="hashtag" placeholder="#해시태그 (10자 이내, 최대 3개)" class="form-control" name="magazineHashtag" pattern='^#.{1,9}$'></td>
                        </tr>
                    </table>
                    ...
                    <script>
	                    ...
	                    var hashtagArr = '${ mag.magazineHashtag }'.split(" ");
